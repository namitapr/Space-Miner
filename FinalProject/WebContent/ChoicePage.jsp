	...
	<body>
		...
		<div id="Main">
			...
			<div class="container" id="CreateGameChoice">
				...
				<form method="POST" action="CreateGame.jsp">
					<button name="CreateGameButton" id="CreateGameButton">Create a Game</button>
			...
			<div class="container" id="JoinGameChoice">
				...
				<form method="POST" action="JoinGame">
					<button name="JoinGameButton" id="JoinGameButton">Join a Game</button>
					<input type="text" name="currUser" id="currUser" style="display:none;" value="<%= user.getUsername() %>" />
				</form>
			</div>
			<div class="container" id="ProfilePageChoice">
				...
				<form method="POST" action="ProfilePage.jsp">
					<button name="ProfilePageButton" id="ProfilePageButton">View Profile</button>
				</form>
			</div>
